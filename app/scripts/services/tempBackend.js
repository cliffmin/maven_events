...
angular.module('mavenApp')
    .service('tempBackend', function ($http) {
        var data;
        return $http({method: 'GET', url:'http://winp179:40080/maven-events/api/v1/events'}).
...
//                'tags': [
//                    'test tag1', 'test tag2', 'test tag3', 'test tag4', 'test tag5', 'test tag6', 'test tag7'
//                ],
//                'type': 'SOP'
//            },
//            {
